...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var stakers, addresses, fileStream, rl, rl_1, rl_1_1, line, _a, address, power, e_1_1, duplicateAddresses;
    var e_1, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                stakers = [];
                addresses = [];
                fileStream = fs_1["default"].createReadStream("addressList_joined");
            ...
            case 3:
                ...
                if (isLineValid(address, power)) {
                    stakers.push({ address: address, power: power });
            ...
            case 12:
                duplicateAddresses = findDuplicates(addresses);
                logger.error({ duplicateAddresses: duplicateAddresses });
                return [2 /*return*/];
        }
    });
}); };
